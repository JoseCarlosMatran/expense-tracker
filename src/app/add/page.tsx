...
import { Plus, Sparkles, Calculator, PiggyBank } from 'lucide-react';
...
export default function AddExpensePage() {
  ...
  return (
    <div className="enhanced-add-page">
      {/* Floating particles */}
        ...
        <div className="header-content">
          ...
          <div className="quick-stats">
            <div className="stat-card">
              <Calculator className="stat-icon" size={20} />
              <div className="stat-label">{t('common.add')} & {t('common.save')}</div>
            </div>
            <div className="stat-card">
              <PiggyBank className="stat-icon" size={20} />
      ...
      <div className={`form-container ${isVisible ? 'animate-in-delayed' : ''}`}>
        <ExpenseForm />
      </div>
      ...
      <style jsx>{`
        ...
        .form-container.animate-in-delayed {
          transform: translateY(0);
          opacity: 1;
        }
